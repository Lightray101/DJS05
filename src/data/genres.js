/**
 * Genre mapping data for podcast application
 * Maps genre IDs to their corresponding titles and descriptions
 */
export const genres = [
  {
    id: 1,
 ...
 * @returns {string} The genre title or "Unknown Genre" if not found
 */
